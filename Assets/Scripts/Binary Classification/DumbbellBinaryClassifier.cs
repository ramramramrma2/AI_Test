...
public class DumbbellBinaryClassifier : MonoBehaviour
{
    ...
    private const int targetLength = 217; // 학습에 사용한 보간 데이터 길이
    private const int numFeatures = 7;
    //학습에 사용된 표준화의 평균과 표준편차
    //private readonly float [ ] means = new float [ numFeatures ] { 0.76618442f,  -0.22545012f,  -0.38813358f,   0.34752774f, -83.85212197f, 17.62857907f , 14.20392677f };
    //private readonly float [ ] stdDevs = new float [ numFeatures ] { 0.46552128f,   0.3059997f,    0.36503711f,   0.72065472f,  72.07897802f,  32.0869189f, 53.74984696f};
    private readonly float [ ] means = new float [ numFeatures ] { 0.76541754f,  -0.2252935f , -0.38852542f , 0.34807705f , -83.99209195f , 17.70747311f , 14.203079f };
    private readonly float [ ] stdDevs = new float [ numFeatures ] { 0.4641704f , 0.30647935f , 0.36559787f , 0.7197338f , 72.11444096f , 32.19447435f , 54.13769161f };
