...
public class DrumBinaryClassifier : MonoBehaviour
{
    ...
    private const int targetLength = 328; // 학습에 사용한 보간 데이터 길이
    private const int numFeatures = 7;
    //학습에 사용된 표준화의 평균과 표준편차
    //private readonly float [ ] means = new float [ numFeatures ] { 0.82987486f , -0.95514518f , 0.08781289f , 0.19923368f , -56.65956092f , 3.36521943f , 10.40836495f };
    //private readonly float [ ] stdDevs = new float [ numFeatures ] { 0.49653832f , 0.07290792f , 0.20130511f , 0.20907655f , 41.96762617f , 15.69924458f , 18.19176816f };

    private readonly float [ ] means = new float [ numFeatures ] { 1.0409537f,   -0.92693489f , 0.11399212f , 0.25858065f , -41.51329804f , 2.99838803f , 12.25090085f };
    private readonly float [ ] stdDevs = new float [ numFeatures ] { 0.65964914f , 0.09932082f , 0.19388408f , 0.22866672f , 37.46735994f , 13.12564073f , 19.86110733f };
