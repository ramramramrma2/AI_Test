...
public class Rainbow : MonoBehaviour
{
    ...
    private readonly float [ ] means = new float [ 7 ] { 1.07638416e+00f, -2.07277773e-01f , 4.74126095e-02f , -3.07068454e-01f , -1.41153852e+01f , 6.23358298e+01f , -2.77083349e+01f , };
    private readonly float [ ] stdDevs = new float [ 7 ] { 0.6839379f , 0.81015381f , 0.28105326f , 0.45890729f , 29.08914326f , 57.61242478f , 40.57573f };
    ...
    void ProcessPredictions ( List<int> predictions )
    {
        ...
        switch ( majorityClass )
        {
            ...
            case 1:
                ...
                resultText. text = $"실패 1: 움직이는 팔의 각도가 부족합니다.";
                break;
            case 2:
                Debug. Log ( "실패 2: 팔꿈치가 구부러졌습니다." );
                resultText. text = $"실패 2: 팔꿈치가 구부러졌습니다.";
                break;
            case 3:
                Debug. Log ( "실패 3: 팔의 위치가 앞으로 나가있습니다." );
                resultText. text = $"실패 3: 팔의 위치가 앞으로 나가있습니다.";
                break;
            default:
